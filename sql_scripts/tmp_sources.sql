...
union
	select
		...
		co.order_completion_date,
		co.order_status,
		co.craftsman_id,
		co.craftsman_name,
		co.craftsman_address,
		co.craftsman_birthday,
		co.craftsman_email,
		co.product_id,
		co.product_name,
		...
		cu.customer_email
	from external_source.craft_products_orders co
	join external_source.customers cu on co.customer_id = cu.customer_id
;
